 ...
 public FlowPane createPage(int index, ArrayList<Ligne> lignes) {
             ...
             try {
                    ...
                    if(l1.getPlacesDisponibles()==0){
                     ...
                     button.setOnAction(e -> {
                            ...
                            String staticUserMail = "yousroutachourabi@live.fr";//va changer selon l'utilisateur connecté
                        try {
    ...
    public void showNotif(){
     ...
     public String QRcode(Ligne ligne){
        ...
        String myCodeText = "votre Ligne "+ligne.getNom()+" de "+ligne.getPointDepart()+" vers "+ligne.getPointArrive()+" à "+ligne.getDateDepart()+" a été reservé avec succes ! ";
        String filePath = "C:\\Users\\yosra\\Desktop\\JardinEnfantJava\\src\\uploads\\"+ligne.getNom()+".png";
