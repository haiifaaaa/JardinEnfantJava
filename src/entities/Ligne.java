...
public class Ligne {
    ...
    public Ligne(int id,int Bus_id, String pointDepart, String pointArrive, Date dateDepart, String nom, int placesDisponibles) {
        this.id = id;
       ...
       public Ligne(int Bus_id, String pointDepart, String pointArrive, Date dateDepart, String nom, int placesDisponibles) {
        this.pointDepart = pointDepart;
        this.pointArrive = pointArrive;
        this.dateDepart = dateDepart;
        this.nom = nom;
